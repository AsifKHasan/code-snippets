...
class SalaryAdviceApp:
    ...
    def save_selection(self, _):
        ...
        yaml.dump(self.config, open('../conf/config.yml', 'w', encoding='utf-8'))
    ...
    def init_generator(self):
        ...
        result = self.advice_generator.init(os.path.abspath('../conf/credential.json'), os.path.abspath('../template'), os.path.abspath('../out'))
...
if __name__ == '__main__':
    ...
    root = tk.Tk()
    root.title('Salary advice generator')
