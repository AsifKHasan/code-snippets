...
WORKSHEET_STRUCTURE_FFBT = {
    'C.02.01-user-registration-management' : {
        'num-columns': 6,
        'columns': {
            'A': {'size': 100, 'halign': 'top', 'halign': 'left', 'wrap': True},
            'B': {'size':  40, 'valign': 'top', 'wrap': True},
            'C': {'size':  30, 'valign': 'top', 'wrap': True},
            'D': {'size': 400, 'valign': 'top', 'wrap': True},
            'E': {'size': 110, 'valign': 'top', 'wrap': True},
            'F': {'size': 220, 'valign': 'top', 'wrap': True},
        },
    },
}
