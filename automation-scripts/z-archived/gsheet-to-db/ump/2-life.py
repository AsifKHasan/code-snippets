...
class SqlScriptGenerator(object):
    ...
    _COMPANIES1 = [{'name': 'popular', 'id': '02'}]

    _COMPANIES = [{'name': 'popular', 'id': '01'},
                  {'name': 'rupalilife', 'id': '02'},
                  {'name': 'primeislami', 'id': '03'},
                  {'name': 'bestlife', 'id': '04'},
                  {'name': 'nrbglobal', 'id': '05'},
                  {'name': 'sunlife', 'id': '06'},
                  {'name': 'pragatilife', 'id': '07'},
                  {'name': 'protective', 'id': '08'},
                  {'name': 'chartered', 'id': '09'},
                  {'name': 'jamuna', 'id': '10'},
                  {'name': 'trust', 'id': '11'},
                  {'name': 'golden', 'id': '12'},
                  {'name': 'fareast', 'id': '13'},
                  {'name': 'zenith', 'id': '14'},
                  {'name': 'sunflower', 'id': '15'},
                  {'name': 'homeland', 'id': '16'},
                  {'name': 'alpha', 'id': '17'},
                  {'name': 'sonali', 'id': '18'},
                  {'name': 'licb', 'id': '19'},
                  ...
                  {'name': 'delta', 'id': '23'},
                  {'name': 'national', 'id': '24'},
                  {'name': 'jibanbima', 'id': '25'},
                  {'name': 'padma', 'id': '26'},
                  {'name': 'meghnalife', 'id': '27'},
                  {'name': 'progressive', 'id': '28'},
                  {'name': 'sandhani', 'id': '29'},
                  {'name': 'mercantileislami', 'id': '30'},
                  {'name': 'swadesh', 'id': '31'},
                  {'name': 'diamond', 'id': '32'},
                  {'name': 'astha', 'id': '33'},
                  {'name': 'nrbislamic', 'id': '34'},
                  {'name': 'akij', 'id': '35'}]
    ...
    def load_script(self, json_file_name):
        ...
        self._GOOGLE_SHEET_NAME = 'Life_Table_State_Data'
    ...
    def generate_script(self, deployment_type,  json_file_name):
        ...
        for i, scripts in dict.items():
            ...
            if self.index_script:
                file_name = 'R__03_00_01__indexLife.sql'
                script_dir = os.path.dirname(os.path.abspath(__file__))
