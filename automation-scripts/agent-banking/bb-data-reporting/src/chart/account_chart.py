...
class AccountChart(ChartBase):
    ...
    def setup_data(self, cumulative_data, period_data):
        ...
        self.data_cumulative = cumulative_data[['current_outlet_total', 'current_outlet_rural', 'current_outlet_urban', 'outlet_total', 'outlet_urban', 'outlet_rural', 'account-total', 'account-urban', 'account-rural', 'account-male', 'account-female', 'account-othergender', 'account-current', 'account-savings', 'account-othertype']]
        self.data_cumulative = self.data_cumulative.rename(columns=dict)

        self.data_period = period_data[['current_outlet_total', 'current_outlet_rural', 'current_outlet_urban', 'outlet_total', 'outlet_urban', 'outlet_rural', 'account-total', 'account-urban', 'account-rural', 'account-male', 'account-female', 'account-othergender', 'account-current', 'account-savings', 'account-othertype']]
        ...
        self.data_cumulative_in_percent['rural'] = self.data_cumulative_in_percent.rural / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['urban'] = self.data_cumulative_in_percent.urban / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['male'] = self.data_cumulative_in_percent.male / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['female'] = self.data_cumulative_in_percent.female / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['other'] = self.data_cumulative_in_percent.other / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['current'] = self.data_cumulative_in_percent.current / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['savings'] = self.data_cumulative_in_percent.savings / self.data_cumulative.total * 100
        self.data_cumulative_in_percent['others'] = self.data_cumulative_in_percent.others / self.data_cumulative.total * 100
        ...
        self.data_period_in_percent['female'] = self.data_period_in_percent.female / self.data_period.total * 100
        self.data_period_in_percent['other'] = self.data_period_in_percent.other / self.data_period.total * 100
        self.data_period_in_percent['current'] = self.data_period_in_percent.current / self.data_period.total * 100
        self.data_period_in_percent['savings'] = self.data_period_in_percent.savings / self.data_period.total * 100
        self.data_period_in_percent['others'] = self.data_period_in_percent.others / self.data_period.total * 100
